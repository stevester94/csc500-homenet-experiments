...
###########################################
base_parameters = {}
base_parameters["experiment_name"] = "oracle_ptn_5_framed"
...
base_parameters["num_examples_per_class_per_domain_source"]=1367
base_parameters["num_examples_per_class_per_domain_target"]=1367
...
base_parameters["dataset_path"] = os.path.join( get_datasets_base_path(), "oracle.frame_indexed.stratified_ds.2022A.pkl" )
...
for source_domains, target_domains in [
    ([8], [14,20,26,32,38,44,50,56]),
    # ([14], [8,20,26,32,38,44,50,56]),
    ([20], [8,14,26,32,38,44,50,56]),
    # ([26], [8,14,20,32,38,44,50,56]),
    ([32], [8,14,20,26,38,44,50,56]),
    # ([38], [8,14,20,26,32,44,50,56]),
    ([44], [8,14,20,26,32,38,50,56]),
    # ([50], [8,14,20,26,32,38,44,56]),
    ([56], [8,14,20,26,32,38,44,50]),
]:

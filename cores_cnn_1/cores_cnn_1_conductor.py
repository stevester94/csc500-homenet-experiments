...
###########################################
base_parameters = {}
base_parameters["experiment_name"] = "cores_cnn_1"
...
custom_parameters['num_examples_per_class_per_domain'] = [100,200,500,1000]
...
conductor = Conductor(
    ...
    EXPERIMENT_PATH=os.path.join(os.environ["DRIVER_ROOT_PATH"], "CORES/cnn/driver_1/"),
    KEEP_MODEL=True,
)
